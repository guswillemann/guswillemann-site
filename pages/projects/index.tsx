...
export default function ProjectPage({ projects, postCardCookie }: ProjectPageProps) {
  ...
  return (
    <>
      ...
      <PostsScreen postType="project" posts={projects} postCardCookie={postCardCookie} title={pageTitle} />
    </>
  );
}
...
export const getServerSideProps: GetServerSideProps = async (ctx) => {
  ...
  const projects = await cms.getPostsList('project', ctx.locale as string);
